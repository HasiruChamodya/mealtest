    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-body text-muted-foreground mt-1">
          {(ROLE_LABELS && ROLE_LABELS[user.role]) || user.role} Dashboard
        </p>
      </div>
            ...
            <Card className="h-full border hover:shadow-md transition-all duration-200 hover:border-primary/30 cursor-pointer">
              <CardHeader className="pb-2">
                <div className="flex items-start justify-between">
                  <div
                    className={`h-10 w-10 rounded-lg bg-accent flex items-center justify-center ${card.color}`}
                  >
              ...
              <CardContent>
                <CardTitle className="text-heading-sm mb-1">
                  {card.title}
                </CardTitle>
